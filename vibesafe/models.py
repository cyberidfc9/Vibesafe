...
PHASE_REGISTRY: list[dict] = [
    ...
    {"number": 7, "name": "Authentication Testing", "type": PhaseType.GUIDED},
    {"number": 8, "name": "Authorization Testing", "type": PhaseType.GUIDED},
    {"number": 9, "name": "Input Validation", "type": PhaseType.AUTOMATED},
    {"number": 10, "name": "File Upload Review", "type": PhaseType.HYBRID},
    {"number": 11, "name": "API Security", "type": PhaseType.AUTOMATED},
    {"number": 12, "name": "Database Security", "type": PhaseType.HYBRID},
    {"number": 13, "name": "Business Logic Testing", "type": PhaseType.GUIDED},
    {"number": 14, "name": "OWASP Top 10 Review", "type": PhaseType.AUTOMATED},
    {"number": 15, "name": "Manual Penetration Testing", "type": PhaseType.GUIDED},
    {"number": 16, "name": "Automated Vulnerability Scan", "type": PhaseType.HYBRID},
    {"number": 17, "name": "Performance & Resilience", "type": PhaseType.HYBRID},
    {"number": 18, "name": "Cloud Security", "type": PhaseType.HYBRID},
    {"number": 19, "name": "Logging & Monitoring", "type": PhaseType.HYBRID},
